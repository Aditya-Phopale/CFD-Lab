...
void Fields::calculate_fluxes(Grid &grid) {
  ...
  for (auto cell : grid.surface_cells()) {
    ...
    if ((cell->is_border(border_position::BOTTOM)) ||
        (cell->is_border(border_position::SOUTHWEST)) ||
    ...
    } else if ((cell->is_border(border_position::NORTHWEST)) ||
               (cell->is_border(border_position::TOP)) ||
    ...
    } else if ((cell->is_border(border_position::SOUTHEAST)) ||
