...
void Case::simulate() {
    ...
    while(t<=_t_end){
        ...
        if(flag>0){
            std::cout<<"Pressure poisson solver did not converge to the given tolerance...";
        }

        //Calculating updated velocities using pressure calculated in the pressure poisson equation
