...
class Fields {
  public:
     ...
     *
     */
    Fields(double _nu, double Re, double alpha, double beta, double _dt, double _tau, int imax, int jmax, double UI,
           double VI, double PI, double TI, double GX, double GY, bool energy_eqn);
    ...
    void calculate_vof_flux(Grid &grid);
