...
class Discretization {
 public:
   ...
   *
   */
  static double convection_u(const Matrix<double> &U, const Matrix<double> &V,
                             int i, int j);
   ...
   *
   */
  static double convection_v(const Matrix<double> &U, const Matrix<double> &V,
                             int i, int j);
   ...
   *
   */
  static double convection_T(const Matrix<double> &U, const Matrix<double> &V,
  ...
  /**
   * @brief Compute interpolated value in the middle between two grid points via
   ...
   * @param[in] i_offset defines index of the second value used for
   * interpolation as i+i_offset
   * @param[in] j_offset defines index of the second value used for
   * interpolation as j+j_offset
   * @param[out] result
   *
   */
  static double interpolate(const Matrix<double> &A, int i, int j, int i_offset,
                            int j_offset);
